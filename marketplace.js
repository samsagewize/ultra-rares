...
connectMarket?.addEventListener('click', async () => {
  try {
    ...
    if (!marketplaceAddress) throw new Error('Wallet connected. Marketplace trading unlocks after contract review and deployment.');
    controls.forEach((control) => { control.disabled = false; });
    marketStatus.textContent = 'Connected to the Ultra Rares $RARE marketplace.';
